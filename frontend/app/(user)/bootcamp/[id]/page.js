...
function WhatIsSection() {
  return (
    <section className={styles.whatIsSection}>
      <Image 
        src="/bootcamp/About.png"
        alt="About Background"
        fill
        className={styles.whatIsBackground}
        style={{ objectFit: 'cover' }}
      />
...
function ChooseTrackSection({ activeTrack, setActiveTrack }) {
  ...
  return (
    <section className={styles.chooseTrackSection}>
      <Image 
        src="/bootcamp/choose.png"
        alt="Choose Background"
        fill
        className={styles.chooseBackground}
        style={{ objectFit: 'cover' }}
      />
...
function WhyJoinSection() {
  ...
  return (
    <section className={styles.whyJoinSection}>
      <Image 
        src="/bootcamp/why_you_should_join.png"
...
function KnowMoreSection() {
  const infoCards = [
    { icon: 'bootcamp', title: 'BOOTCAMP', description: 'Explore all the details about the bootcamp and prepare yourself for success!' },
    { icon: 'insight', title: 'INSIGHT', description: 'Explore all the details about the bootcamp and prepare yourself for success!' },
    { icon: 'glory', title: 'GLORY', description: 'Explore all the details about the bootcamp and prepare yourself for success!' },
    { icon: 'info', title: 'INFO', description: 'Explore all the details about the bootcamp and prepare yourself for success!' },
    { icon: 'talks', title: 'TALKS', description: 'Explore all the details about the bootcamp and prepare yourself for success!' }
  ];

  const getIcon = (type) => {
    const icons = {
      bootcamp: <svg width="28" height="28" viewBox="0 0 24 24" fill="white"><rect x="5" y="4" width="14" height="17" rx="2" stroke="white" strokeWidth="1.5" fill="none"/><rect x="8" y="2" width="8" height="4" rx="1" fill="white"/></svg>,
      insight: <svg width="28" height="28" viewBox="0 0 24 24" fill="white"><circle cx="12" cy="8" r="3" fill="white"/><path d="M12 14C8 14 4 16 4 19V21H20V19C20 16 16 14 12 14Z" fill="white"/></svg>,
      glory: <svg width="28" height="28" viewBox="0 0 24 24" fill="white"><path d="M20 7H17L15 4H9L7 7H4C2.9 7 2 7.9 2 9V19C2 20.1 2.9 21 4 21H20C21.1 21 22 20.1 22 19V9C22 7.9 21.1 7 20 7ZM12 18C9.24 18 7 15.76 7 13C7 10.24 9.24 8 12 8C14.76 8 17 10.24 17 13C17 15.76 14.76 18 12 18Z" fill="white"/></svg>,
      info: <svg width="28" height="28" viewBox="0 0 24 24" fill="white"><circle cx="12" cy="12" r="10" stroke="white" strokeWidth="1.5" fill="none"/><path d="M12 8V12M12 16H12.01" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>,
      talks: <svg width="28" height="28" viewBox="0 0 24 24" fill="white"><path d="M20 2H4C2.9 2 2 2.9 2 4V22L6 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2Z" fill="white"/></svg>
    };
    return icons[type];
  };
  ...
  return (
    <section className={styles.knowMoreSection}>
      <Image 
        ...
        fill
        className={styles.knowMoreBackground}
        style={{ objectFit: 'cover' }}
      />
